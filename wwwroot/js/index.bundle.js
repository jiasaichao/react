...
/***/ function(module, exports, __webpack_require__) {
	...
	var routers_1 = __webpack_require__(1);
	ReactDOM.render(routers_1.default, document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var react_router_1 = __webpack_require__(26);
	//import { syncHistoryWithStore, routerReducer} from 'react-router-redux'
	var app_1 = __webpack_require__(86);
	var button_1 = __webpack_require__(87);
	var login_1 = __webpack_require__(98);
	var mainlayout_1 = __webpack_require__(99);
	var general_1 = __webpack_require__(100);
	var tableview_1 = __webpack_require__(101);
	//import Modeules from './controller/index';
	//import {BaseStore} from './redux/store/BaseStore';
	//import URL_CONFIG from './routersConfig';
	//const store = BaseStore();
	//const history = syncHistoryWithStore(hashHistory, store);
	var store_1 = __webpack_require__(102);
	//store.subscribe(()=>{console.log('改变了')})
	var appRootComponent = (React.createElement(react_redux_1.Provider, {store: store_1.store}, React.createElement(react_router_1.Router, null, React.createElement(react_router_1.Route, {path: "/", component: app_1.default}, React.createElement(react_router_1.IndexRoute, {component: login_1.default}), React.createElement(react_router_1.Route, {path: "/index", component: mainlayout_1.default}, React.createElement(react_router_1.IndexRoute, {component: button_1.default}), React.createElement(react_router_1.Route, {path: 'general', component: general_1.default}), React.createElement(react_router_1.Route, {path: 'table', component: tableview_1.default}))))));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Lifecycle2 = __webpack_require__(72);
	
	var _Lifecycle3 = _interopRequireDefault(_Lifecycle2);
	
	var _RouteContext2 = __webpack_require__(73);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _computeChangedRoutes2 = __webpack_require__(54);
	
	var _computeChangedRoutes3 = _interopRequireDefault(_computeChangedRoutes2);
	
	var _TransitionUtils = __webpack_require__(55);
	
	var _isActive2 = __webpack_require__(57);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _makeStateWithLocation = __webpack_require__(59);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ButtonView = React.createClass({
	    render: function () {
	        return (React.createElement(index_1.ButtonSubmit, null, "确认按钮"));
	    }
	});
	Object.defineProperty(exports, "__esModule", { value: true });
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (CurrentState) {
	    /**正常*/
	    CurrentState[CurrentState["Normal"] = 1] = "Normal";
	    /**选中*/
	    CurrentState[CurrentState["Active"] = 2] = "Active";
	    /**鼠标移上去*/
	    CurrentState[CurrentState["Mouse"] = 3] = "Mouse";
	...
	var Button = (function (_super) {
	    ...
	    function Button(props) {
	        _super.call(this, props);
	        var state = this.props.state || CurrentState.Normal;
	    ...
	    Button.prototype.render = function () {
	        ...
	        if (typeof (this.props.href) != 'undefined') {
	            click = function () {
	                window.location.href = _this.props.href;
	            };
	        }
	        else {
	            click = this.props.onClick;
	        }
	        var style = common_1.Common.prepareStyles({
	            textDecoration: "none",
	            display: "flex",
	            alignItems: "center"
	        });
	 ...
	 * 提交按钮，就是加了提交按钮的颜色
	 */
	var ButtonSubmit = (function (_super) {
	    __extends(ButtonSubmit, _super);
	...
	var ButtonClose = (function (_super) {
	    ...
	    ButtonClose.prototype.render = function () {
	        var styles = {
	            ...
	            style: common_1.Global.styles.create()
	        };
	        styles.style.merge(common_1.Global.styles.absolute('15px', '15px'));
	        return (React.createElement("div", null, React.createElement(Button, {style: styles.style.o, onClick: this.props.handleOnClick, color: { Normal: styles.normal, Mouse: styles.mouse, Active: styles.normal }}, React.createElement("span", {className: 'icon-corss'}))));
	    };
	    return ButtonClose;
	}(React.Component));
...
/***/ function(module, exports) {
	...
	var Common = (function () {
	    ...
	    /**准备样式，方便合并样式*/
	    Common.prepareStyles = function (s) {
	        return new Styles(s);
	    };
	    return Common;
	}());
	...
	var Styles = (function () {
	    ...
	    Styles.prototype.merge = function () {
	        var s = [];
	...
	var Color_O = (function () {
	    /**
	      ...
	      */
	    function Color_O(thebg, thefont, thebgMouse, thefontMouse, thebgActive, thefontActive) {
	        if (thebgMouse === void 0) { thebgMouse = null; }
	        if (thefontMouse === void 0) { thefontMouse = null; }
	        if (thebgActive === void 0) { thebgActive = null; }
	        if (thefontActive === void 0) { thefontActive = null; }
	        this.bg = thebg;
	...
	var Colors = (function () {
	    ...
	    Colors.mainActive = "#36c6d3";
	    /**深一个颜色 */
	    Colors.mainActive_deep1 = "#26a1ab";
	    /**主要色调，背景色，深的颜色，滑动菜单背景色，比头部背景色要浅 */
	    Colors.mainBackground = "#364150";
	    /**头部背景色 */
	    Colors.bgHeader = '#2b3643';
	    /**头部鼠标移上背景色 */
	    Colors.bgHeaderMouse = '#3F4F62';
	    /**头部当前背景色 */
	    Colors.bgHeaderActive = Colors.mainActive;
	    /**头部字体色 */
	    Colors.fontHeader = '#c6cfda';
	    /**头部鼠标移上字体色 */
	    Colors.fontHeaderMouse = '#d5dce4';
	    /**头部当前字体色 */
	    ...
	    Colors.bgSidebarActive = Colors.mainActive;
	    Colors.fontSidebar = '#b4bcc8';
	    ...
	    /**分页按钮颜色组*/
	    Colors.butonPage = new Color_O('#fff', Colors.colorshen1, Colors.colorMouse, Colors.colorshen1, Colors.colorshen1, '#fff');
	    return Colors;
	}());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Header = (function (_super) {
	    ...
	    Header.prototype.render = function () {
	        var hb = common_1.Common.prepareStyles;
	        var styles = {
	            wrapper: hb({
	                height: '46px',
	                width: '100%',
	                background: common_1.Global.colors.bgHeader,
	                display: "flex",
	                alignItems: "center"
	            }),
	            left: {
	                padding: "0 " + common_1.Global.padding + "px",
	                display: "flex",
	                alignItems: "center",
	                width: "195px"
	            },
	        ...
	        return React.createElement("div", {style: styles.wrapper.o}, React.createElement("div", {style: styles.left}, React.createElement("a", {style: styles.logo, href: "#"}, "首页"), React.createElement("span", {style: { flexGrow: 1 }}), React.createElement("span", {style: { fontSize: "24px", color: "#fff" }, className: "icon-menu"})), React.createElement("div", {style: styles.right}, this.props.children));
	    };
	    return Header;
	}(React.Component));
	Object.defineProperty(exports, "__esModule", { value: true });
...
/***/ function(module, exports, __webpack_require__) {
	...
	/// <reference path="../../typings/browser.d.ts" />
	var common_1 = __webpack_require__(90);
	var public_1 = __webpack_require__(93);
	var button_1 = __webpack_require__(89);
	...
	var Table = (function (_super) {
	    ...
	    function Table() {
	        ...
	        */
	        this.renderPage = function () {
	            console.log(SL.czjz);
	            return (React.createElement("div", {style: SL.create(SL.czjz).merge({ height: 45 }).o}, React.createElement(public_1.Placeholder, null), React.createElement("ul", {style: SL.create(SL.czjz).o}, React.createElement("li", null, React.createElement(button_1.Button, {color: common_1.Colors.butonPage, style: { height: 33, padding: "0 12px", border: "1px solid #ddd", marginLeft: -1 }}, '<')), React.createElement("li", null, React.createElement(button_1.Button, {color: common_1.Colors.butonPage, style: { height: 33, padding: "0 12px", border: "1px solid #ddd", marginLeft: -1 }}, "1")), React.createElement("li", null, React.createElement(button_1.Button, {color: common_1.Colors.butonPage, style: { height: 33, padding: "0 12px", border: "1px solid #ddd", marginLeft: -1 }}, "2")), React.createElement("li", null, React.createElement(button_1.Button, {color: common_1.Colors.butonPage, style: { height: 33, padding: "0 12px", border: "1px solid #ddd", marginLeft: -1 }}, "3")))));
	        };
	    }
	    Table.prototype.render = function () {
	        var columns = this.renderColumns(this.props.columns);
	        var body = this.renderBody(this.props.dataSource);
	        var page = this.renderPage();
	        console.log(body);
	        return (React.createElement("div", null, React.createElement("table", {style: { width: '100%', border: 'solid #e7ecf1', borderWidth: '1px 0 0 1px' }}, React.createElement("thead", null, React.createElement("tr", {style: { height: '36px' }}, columns)), React.createElement("tbody", null, body)), React.createElement("div", null, page)));
	    };
	    /**
	     * 渲染列头
	     * @param columns 列头数据
	    ...
	    Table.prototype.renderColumns = function (columns) {
	        var E = columns.map(function (column, index) {
	            return (React.createElement(Th, null, column.title));
	        });
	        return E;
	    };
	    /**
	     ...
	     * @param columns 列头数据
	     */
	    Table.prototype.renderBody = function (body) {
	        var _this = this;
	        var E = body.map(function (item, index) {
	            return (React.createElement(Tr, null, _this.props.columns.map(function (column, i1) {
	                return (React.createElement(Td, null, item[column.dataIndex]));
	            })));
	        });
	        return E;
	    };
	...
	var Tr = (function (_super) {
	    ...
	    function Tr(props) {
	        var _this = this;
	        _super.call(this, props);
	        this._handleMouseOver = function () {
	            _this.setState({
	                mouseOver: true
	            });
	        };
	    ...
	    Tr.prototype.render = function () {
	        var style = common_1.Common.prepareStyles({ height: '36px' });
	        if (this.state.mouseOver) {
	            style.merge({ background: '#EEF1F5' });
	        }
	        return (React.createElement("tr", {style: style.o, onMouseOver: this._handleMouseOver, onMouseOut: this._handleMouseOut}, this.props.children));
	    };
	    return Tr;
	}(React.Component));
	var Td = (function (_super) {
	    ...
	    Td.prototype.render = function () {
	        return (React.createElement("td", {style: { border: 'solid #e7ecf1', borderWidth: '0 1px 1px 0', padding: '0 8px' }}, this.props.children));
	    };
	    return Td;
	}(React.Component));
	...
	var NavigationBar = (function (_super) {
	    ...
	    NavigationBar.prototype.render = function () {
	        ...
	        var childrenElements = React.Children.map(children, function (el, index) {
	            if (el.type.name === "NavigationBarItem") {
	                var i = React.cloneElement(el, { lable: el.props.lable, icon: el.props.icon });
	                return i;
	            }
	        });
	        return (React.createElement("ul", {style: common_1.Global.styles.create(common_1.Global.styles.czjz).merge({ height: "43px", padding: "0 " + common_1.Global.padding + "px", background: "#fff", border: "1px solid #e7ecf1", flex: 1 }).o}, childrenElements));
	    };
	    return NavigationBar;
	}(React.Component));
	exports.NavigationBar = NavigationBar;
	var NavigationBarItem = (function (_super) {
	    __extends(NavigationBarItem, _super);
	    function NavigationBarItem(props) {
	        _super.call(this, props);
	        this.state = { state: CurrentState.Normal };
	    }
	    NavigationBarItem.prototype.render = function () {
	        var i;
	        var styles = {
	        ...
	        if (this.props.icon == null || this.props.icon == true) {
	            i = React.createElement("i", {className: "icon-chevron-right"});
	        }
	        return (React.createElement("li", {style: { display: "flex", color: "#888" }}, React.createElement("a", {onMouseOver: this._handleMouseOver.bind(this), onMouseOut: this._handleMouseOut.bind(this), style: styles.a, href: "#"}, this.props.lable), i));
	    };
	    NavigationBarItem.prototype._handleMouseOver = function () {
	        this.setState({
	            state: CurrentState.Mouse
	        });
	    };
	    NavigationBarItem.prototype._handleMouseOut = function () {
	        this.setState({
	            state: CurrentState.Normal
	        });
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SidebarItems = (function (_super) {
	    ...
	    SidebarItems.prototype.render = function () {
	        ...
	        var styles = {
	            children: common_1.Common.prepareStyles({
	        ...
	        /**子元素*/
	        var i;
	        i = React.createElement("ul", {style: styles.children.o, ref: "aaaac"}, this.props.children);
	...
	var SidebarItem = (function (_super) {
	    ...
	    SidebarItem.prototype.render = function () {
	        ...
	        return (React.createElement("li", null, React.createElement(button_1.Button, {color: common_1.Global.colors.sidebaritem, onClick: this.props.handleOnClick, style: styles.style.o}, this.props.lable)));
	    };
	    return SidebarItem;
	}(React.Component));
	// export {SidebarItems}
	...
	(function (Alert) {
	    ...
	    var Base = (function (_super) {
	        ...
	        Base.prototype.render = function () {
	            ...
	            return (React.createElement("div", {style: styles.root.o}, React.createElement("div", null, this.props.children)));
	        };
	        return Base;
	    }(React.Component));
	    Alert.Base = Base;
	    ...
	    var Close = (function (_super) {
	        ...
	        function Close(props) {
	            ...
	            var state = this.props.show || false;
	        ...
	        Close.prototype.render = function () {
	            ...
	            return (React.createElement(Base, {style: styles.root.o, type: this.props.type}, this.props.children, React.createElement(button_1.ButtonClose, {handleOnClick: this.handleClose})));
	        };
	        return Close;
	    }(React.Component));
	    Alert.Close = Close;
	    var Error = (function (_super) {
	        ...
	        Error.prototype.render = function () {
	            return (React.createElement(Base, {type: 'error'}, this.props.children));
	        };
	        return Error;
	    }(React.Component));
	    Alert.Error = Error;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Portlet = (function (_super) {
	    ...
	    Portlet.prototype.render = function () {
	        return (React.createElement("div", {style: { padding: '20px', background: '#F1F3FA' }}, React.createElement("div", {style: {
	            border: '1px solid #e7ecf1', padding: '12px 20px 15px', backgroundColor: '#fff'
	        }}, React.createElement("div", {style: { display: 'flex', alignItems: 'center', borderBottom: '1px solid #eee', marginBottom: '10px', minHeight: '41px' }}, this.props.title), React.createElement("div", null, this.props.children))));
	    };
	    return Portlet;
	}(React.Component));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Login = (function (_super) {
	    ...
	    Login.prototype.render = function () {
	        ...
	        return (React.createElement("div", {style: SL.create({
	            height: '100%', background: common_1.Global.colors.mainBackground
	        }).merge(SL.spjzcolumn).o}, React.createElement("div", {style: SL.create({ marginTop: 100, background: '#fff', width: 400, padding: '10px 30px' }).merge(SL.spjzcolumn).o}, React.createElement("h2", {style: { color: CL.mainActive, fontSize: 28, margin: '20px 0 25p 0', lineHeight: '50px' }}, "登录"), React.createElement(alert_1.Alert.Close, {show: true, type: 'success'}, "警告111"), React.createElement("input", {placeholder: 'Username', style: styles.input}), React.createElement("input", {placeholder: 'Password', style: styles.input}), React.createElement(button_1.ButtonSubmit, {style: { padding: '10px 20px', marginTop: 10 }, onClick: this.Submit}, "登录"))));
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = React.createClass({
	    render: function () {
	        return (React.createElement(index_1.Portlet, {title: '提示'}, React.createElement(index_1.Alert.Close, {show: true, type: 'error'}, "错误测试测试测试测试测试测试测试"), React.createElement(index_1.Alert.Error, null, "错误样式")));
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = React.createClass({
	    render: function () {
	        return (React.createElement(index_1.Portlet, {title: '表格实例'}, React.createElement(index_1.Table, {columns: [{ title: '列1', dataIndex: 'name' }, { title: '列2', dataIndex: 'name1' }], dataSource: [{ name: '内容1', name1: '内容2' }, { name: '内容1', name1: '内容2' }, { name: '内容1', name1: '内容2' }]})));
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var react_router_redux_1 = __webpack_require__(103);
	var react_router_1 = __webpack_require__(26);
	var defaultState = {
	    sidebar: {
	        active: 1,
	...
	var store = redux_1.createStore(function (state, action) {
	    ...
	    switch (action.type) {
	        ...
	        case 'url':
	            ...
	            store.dispatch(react_router_redux_1.push(action.url));
	            return state;
	        default:
	            return state;
	    }
