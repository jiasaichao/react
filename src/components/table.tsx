        ...
        return (
            <div style={SL.create(SL.czjz).merge({height:45}).o}>
                ...
                <ul style={SL.create(SL.czjz).o}>
                    <li><Button color={Colors.butonPage} style={{ height: 33, padding: "0 12px", border: "1px solid #ddd", marginLeft: -1 }}>{'<'}</Button></li>
                    <li><Button color={Colors.butonPage} style={{ height: 33, padding: "0 12px", border: "1px solid #ddd", marginLeft:-1 }}>1</Button></li>
                    <li><Button color={Colors.butonPage} style={{ height: 33, padding: "0 12px", border: "1px solid #ddd", marginLeft: -1 }}>2</Button></li>
                    <li><Button color={Colors.butonPage} style={{ height: 33, padding: "0 12px", border: "1px solid #ddd", marginLeft: -1 }}>3</Button></li>
                </ul>
            </div>
            );
    }
